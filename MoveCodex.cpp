...
void MoveCodex::init(){
	...
	peck.addEffect(30, DAMAGE, ENEMY, NONE, ConditionCodex::get(NONE), MoveConditionCodex::get(NONE));
	_moveList.push_back(peck);

	//9
	Move quickDive = Move("Quick Dive", 5, 100);
	quickDive.addEffect(20, DAMAGE, ENEMY, NONE, ConditionCodex::get(NONE), MoveConditionCodex::get(NONE));
	_moveList.push_back(quickDive);

	//10
	Move puffUp = Move("Puff Up", 1, 100);
	puffUp.addEffect(-1, DEBUFF, ENEMY, ATTACK, ConditionCodex::get(NONE), MoveConditionCodex::get(NONE));
	_moveList.push_back(puffUp);

	//11
	Move sharpen = Move("Sharpen", 1, 100);
	sharpen.addEffect(1, BUFF, SELF, ATTACK, ConditionCodex::get(NONE), MoveConditionCodex::get(NONE));
	_moveList.push_back(sharpen);

	//12
	Move bite = Move("Bite", 0, 100);
	bite.addEffect(30, DAMAGE, ENEMY, NONE, ConditionCodex::get(NONE), MoveConditionCodex::get(NONE));
	_moveList.push_back(bite);

	//13
	Move thrash = Move("Thrash", 0, 90);
	thrash.addEffect(40, DAMAGE, ENEMY, NONE, ConditionCodex::get(NONE), MoveConditionCodex::get(NONE));
	thrash.addEffect(20, DAMAGE, SELF, NONE, ConditionCodex::get(NONE), MoveConditionCodex::get(NONE));
	_moveList.push_back(thrash);

	//14
	Move digIn = Move("Dig In", 1, 100);
	digIn.addEffect(1, BUFF, SELF, ARMOR, ConditionCodex::get(NONE), MoveConditionCodex::get(NONE));
	digIn.addEffect(-1, DEBUFF, SELF, AGILITY, ConditionCodex::get(NONE), MoveConditionCodex::get(NONE));
	_moveList.push_back(digIn);

	//15
	Move sprout = Move("Sprout", 1, 100);
	sprout.addEffect(1, BUFF, SELF, ATTACK, ConditionCodex::get(NONE), MoveConditionCodex::get(NONE));
	sprout.addEffect(-1, DEBUFF, ENEMY, AGILITY, ConditionCodex::get(NONE), MoveConditionCodex::get(NONE));
	_moveList.push_back(sprout);

	//16
	Move strongOdor = Move("Strong Odor", 0, 100);
	strongOdor.addEffect(20, DAMAGE, ENEMY, NONE, ConditionCodex::get(SICKENED), MoveConditionCodex::get(NONE));
